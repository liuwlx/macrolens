...
async def _event_summary(session: SessionDep, event: ReleaseEvent, definition: ReleaseDefinition, provider: Provider) -> ReleaseEventSummary:
    metric_rows = (
...
async def list_events(
    ...
    items = [await _event_summary(session, event, definition, source) for event, definition, source in rows]
