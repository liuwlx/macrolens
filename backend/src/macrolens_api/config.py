...
class Settings(BaseSettings):
    ...
    federal_reserve_calendar_url: str = "https://www.federalreserve.gov/monetarypolicy/fomccalendars.htm"
    ...
    def validate_production_safety(self) -> "Settings":
        ...
        if self.jwt_secret == "replace-with-at-least-32-random-characters" or len(self.jwt_secret) < 32:
            errors.append("JWT_SECRET must be a unique secret of at least 32 characters")
        if self.bootstrap_admin_password == "change-me-now" or len(self.bootstrap_admin_password) < 12:
            errors.append("BOOTSTRAP_ADMIN_PASSWORD must be changed and contain at least 12 characters")
