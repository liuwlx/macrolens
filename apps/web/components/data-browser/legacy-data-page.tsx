...
/* eslint-disable react-hooks/set-state-in-effect -- frozen legacy page retained verbatim for feature-flag rollback */
...
export function LegacyDataPage() { return <Suspense fallback={<LoadingBlock/>}><DataContent/></Suspense>; }
